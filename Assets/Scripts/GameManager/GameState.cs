...
public class GameState : AState
{
    ...
    {
        carbonText.text = Mathf.RoundToInt(inventory.CarbonCount).ToString() + " / " + inventory.MaxCarbonCount;
        compostText.text = inventory.CompostCount.ToString();
        metalText.text = inventory.MetalCount.ToString();
        nuclearText.text = inventory.NuclearCount.ToString();
